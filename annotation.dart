...
/// each call to any public method of the class. Public methods are automatically
/// generated by the package based on the private methods defined by the user.
///
...
///
/// Users should define private methods (e.g., `_methodName`) with relevant annotations
/// (`@Precondition`, `@Postcondition`, or `@Invariant`). Public methods with the same
/// name (e.g., `methodName`) are generated by the package, which enforce the specified
/// contract checks.
///
/// Example:
/// ```dart
...
///
/// ### Key Notes:
/// - **Private Methods Only**: Users can define only private methods (e.g., `_methodName`) and annotate them.
/// - **Generated Public Methods**: Public methods (e.g., `methodName`) are automatically generated by the package and include all necessary contract checks.
/// - **Class-Level Invariants**: Declared using `@Contract` and enforced in all generated public methods.
...
/// are checked **before** and **after** the execution of the private method.
///
/// This annotation is intended for private methods that do not have explicit `@Precondition` or `@Postcondition` annotations.
